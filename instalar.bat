...
:: Crear config.json si no existe (firstRun para setup inicial)
if not exist "config.json" (
    echo { "firstRun": true, "auth": { "username": "", "password": "" } } > config.json
    echo      Archivo config.json creado. OK
) else (
    echo      Archivo config.json ya existe. OK
)
...
echo  el sistema y configurar tus credenciales.
echo ==========================================
echo.
pause
